...
const filterStringsWithVowels = (arr) => {
  ...
  filteredArr = arr.filter( (value) => regex.test(value));
...
// Solution code here...
// let uniqueNumArr = [];
// uniqueNumArr = forbiddenValues.filter( (firstArr) => {
//   arr.forEach( (secondArr,index) => {
...
// });
// return uniqueNumArr;
// let uniqueNumArr = arr.filter( (firstArr) => {
//   let shouldAddToArr = 1;
//   // let isUnique = 0;
//   for (let i = 0; i < forbiddenValues.length; i++) {  
//     console.log('_  ');
//     console.log('pass: ', i);
//     console.log('first: ',firstArr);
//     console.log('second: ',forbiddenValues[i]);
//     if (firstArr===forbiddenValues[i]) {
//       console.log('true');
//       shouldAddToArr = 0;
//     };
//     console.log('shouldAddToArr: ',shouldAddToArr);
//   };
//   return shouldAddToArr;
// });
// return uniqueNumArr;
